...
# soil_water_forecasting documentation build
...
from soil_water_forecasting import __version__ as release

# -- Project information -----------------------------------------------------

project = "soil_water_forecasting"
author = "Kedro"
...
htmlhelp_basename = "soil_water_forecastingdoc"
...
latex_documents = [
    (
        master_doc,
        "soil_water_forecasting.tex",
        "soil_water_forecasting Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "soil_water_forecasting",
        "Project soil_water_forecasting codebase.",
        "Data-Science",
    )
]
